...
public class RegionMapTest {
    @Test
    public void should_Throw_If_SizeX_Too_Small() {
        assertThrows(IllegalArgumentException.class, () -> new RegionMap(0, 1));
    }

    @Test
    public void should_Throw_If_SizeY_Too_Small() {
        assertThrows(IllegalArgumentException.class, () -> new RegionMap(1, 0));
    }
